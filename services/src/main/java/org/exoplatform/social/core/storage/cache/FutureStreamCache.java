 ...
 */
public abstract class FutureStreamCache<K, V, C>
{
   ...
   /** . */
   private final Logger log = LoggerFactory.getLogger(FutureStreamCache.class);

   public FutureStreamCache(Loader<K, V, C> loader)
   {
      this.loader = loader;
    ...
    */
   protected abstract V get(K key, int offset, int limit);
    ...
    * @return the value
    */
  public final V get(final C context, final K key, final int offset, final int limit) {

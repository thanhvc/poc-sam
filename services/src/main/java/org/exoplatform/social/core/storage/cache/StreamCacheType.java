...
public enum StreamCacheType {
  ACTIVITIES_GRAPH("ActivitiesGraphCache")
  ;

  private final String name;

  private StreamCacheType(final String name) {
    this.name = name;
  }
  ...
  public <T extends Serializable, K extends CacheKey, V extends AbstractFixedSizeListData<T>> FutureStreamExoCache<T, K, V, ServiceContext<V>> createFutureStreamCache(ExoCache<K, V> cache) {
